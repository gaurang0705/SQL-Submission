...
SELECT m.firstname, m.surname, sub.name, sub.cost
FROM (
...
select f1.name , revenue.total_revenue
...
on f1.name = revenue.name
where revenue.total_revenue < 1000
order by revenue.total_revenue 
